...
export default function HeroSection() {
    return (
        <div className="w-full h-[100vw] md:h-[100vh] flex items-center justify-center relative bg-gamejam-pattern bg-no-repeat bg-left-bottom bg-cover">
            ...
            <div className="text-center m-auto md:m-10 md:mt-[-25px] p-6 ">
                ...
                <div className="flex justify-center items-center gap-6">
                    ...
                    <a href="https://forms.gle/x7bbBkKKVyGvUSLn7" target="_blank" rel="noopener noreferrer">
