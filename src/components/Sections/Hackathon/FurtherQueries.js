    ...
    return (
        <div className={"text-center pb-16 sm:pb-[15%] relative bg-color-gray"}>
            ...
            <p className={"w-[90%] sm:w-3/4 md:w-1/2 mx-auto mt-4 sm:mt-10 text-sm sm:text-lg font-medium"}>
                If you have any further queries, feel free to contact us at <a href="mailto:hackathon@buetcsefest2023.com" className={"text-color-secondary hover:text-color-primary"}>hackathon@buetcsefest2023.com</a>
            </p>
